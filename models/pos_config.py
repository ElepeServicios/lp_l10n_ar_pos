...
class PosConfig(models.Model):
    ...
    auto_invoice_check = fields.Boolean(string='POS auto invoice',
                                        ...
                                        default=True)
    show_invoice_number = fields.Boolean('Show invoice number on Receipt', default=True)
    show_customer_vat = fields.Boolean('Show customer VAT on Receipt', default=True)
